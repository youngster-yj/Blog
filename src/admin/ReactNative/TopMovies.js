...
class MainMovies extends Component {
    ...
    componentWillMount() {
        fetch(servicePath.gettopmovies, {
            method: 'GET',
            headers: {
    ...
    handleOk(){ //修改
        ...
        if(name.length!=0&&thumb.length!=0&&movie.length!=0){
            ...
            body:'type=top' + '&id=' + id + '&name=' + name + '&thumb=' + thumb + '&movie=' + movie 
        })
            .then(res => res.json())
            .then((data) => {
                if (data) {
    ...
    addhandleOk(){
        ...
        if(name.length!=0&&thumb.length!=0&&movie.length!=0){
            ...
            body:'type=top' + '&name=' + name + '&thumb=' + thumb + '&movie=' + movie 
        })
            .then(res => res.json())
            .then((data) => {
                console.log(data)
