...
class MainMovies extends Component {
    ...
    componentWillMount() {
        fetch(servicePath.getbottommovies, {
            method: 'GET',
            headers: {
    ...
    handleOk(){ //修改
        ...
        if(name.length!=0&&thumb.length!=0&&movie.length!=0){
            ...
            body:'type=bottom' + '&id=' + id + '&name=' + name + '&thumb=' + thumb + '&movie=' + movie 
        })
            .then(res => res.json())
            .then((data) => {
                if (data) {
    ...
    addhandleOk(){
        ...
        if(name.length!=0&&thumb.length!=0&&movie.length!=0){
            ...
            body:'type=bottom' + '&name=' + name + '&thumb=' + thumb + '&movie=' + movie 
        })
            .then(res => res.json())
            .then((data) => {
                console.log(data)
